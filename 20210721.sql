...
-- FOREUGN KEY (컬럼명) REFERENCES 연결테이블 (PK컬럼);
...
-- 와 같은 형식으로 지정할 수 있습니다. 
 ...
 SELECT * FROM usertbl;
 DELIMITER $$
 CREATE PROCEDURE singerAge(IN userName VARCHAR(10))
BEGIN
	DECLARE bYear INT;
...
DELIMITER $$
CREATE PROCEDURE getFive2(IN empno int)
BEGIN
